...
```bash
git clone https://github.com/jabamiyume/swisstronik-deploy-private-nft.git
```
```bash
...
contract PrivateNFT is ERC721, Ownable {
    ...
    constructor(address initialOwner) ERC721("BlumPrivate", "BLUMPRVT") Ownable(initialOwner) {}
